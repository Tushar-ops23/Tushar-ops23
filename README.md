...
DevOps engineer in Noida. I build hub-and-spoke networks on AWS, Azure and GCP, run private Kubernetes clusters, and set up CI that deploys without ever holding a cloud key.

Currently at Ksolves India. Before that, BUOPSO, and before that a degree in mechanical engineering.
...
**Day to day:** Terraform, Kubernetes (EKS / AKS / GKE), Helm, Istio, Azure DevOps, GitHub Actions, Vault, Prometheus, Grafana, OpenTelemetry.

[tushar-ops23.github.io](https://tushar-ops23.github.io) · [LinkedIn](https://www.linkedin.com/in/tushar-panchal23/) · tusharpanchal529@gmail.com
